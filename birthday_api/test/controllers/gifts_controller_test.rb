...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { name: @gift.name, price: @gift.price, sender: @gift.sender } }, as: :json
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { name: @gift.name, price: @gift.price, sender: @gift.sender } }, as: :json
    assert_response 200
  end
